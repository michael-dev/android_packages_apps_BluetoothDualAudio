...
[`michael-dev/android_packages_modules_Bluetooth`](https://github.com/michael-dev/android_packages_modules_Bluetooth),
...
{
  "repository": "michael-dev/android_packages_apps_BluetoothDualAudio",
  "target_path": "packages/apps/BluetoothDualAudio"
},
{
  "repository": "michael-dev/android_packages_modules_Bluetooth",
...
- [DUAL_A2DP.md](https://github.com/michael-dev/android_packages_modules_Bluetooth/blob/dual-a2dp/docs/DUAL_A2DP.md) — overall architecture + patch surface
- [REBASE.md](https://github.com/michael-dev/android_packages_modules_Bluetooth/blob/dual-a2dp/docs/REBASE.md) — keeping the fork in sync with upstream LineageOS
- [UPSTREAM.md](https://github.com/michael-dev/android_packages_modules_Bluetooth/blob/dual-a2dp/docs/UPSTREAM.md) — notes for submitting to AOSP Gerrit
